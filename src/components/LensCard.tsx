        ...
        <div className="relative z-10">
          ...
          >
            <Button 
              ...
              className="w-full md:bg-violet-500/20 md:text-violet-400 hover:md:bg-violet-500/20 hover:md:text-violet-400  rounded-full font-bold flex gap-2 hover:scale-105"
            >
